<div x-show="sidebarOpen" x-transition:enter="transition ease-in-out duration-300 transform" x-transition:leave="transition ease-in-out duration-300 transform" class="lg:hidden relative z-50">
    <!-- Backdrop -->
    <div class="fixed inset-0 bg-gray-900/80" @click="sidebarOpen = false" aria-hidden="true"></div>
